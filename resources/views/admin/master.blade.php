...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('theme/backend/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css" />
        <!-- DataTables -->
    ...
    <body data-topbar="dark">
        ...
        <script src="{{ asset('theme/backend/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
